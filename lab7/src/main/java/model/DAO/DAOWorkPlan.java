...
public class DAOWorkPlan extends DAO {
    ...
    private final String GET_PLAN_BY_ID = "SELECT * FROM WORK_PLAN WHERE plan_id = ?;";
    private final String INSERT_PLAN = "INSERT INTO WORK_PLAN(request_id, worker_id) VALUES(?, ?);";
    private final String DELETE_PLAN_BY_ID = "DELETE FROM WORK_PLAN WHERE plan_id = ?";
    private final String CHANGE_WORK_PLAN_STATUS_BY_REQUEST_ID = "UPDATE WORK_PLAN SET is_completed = ? WHERE request_id = ?;";
